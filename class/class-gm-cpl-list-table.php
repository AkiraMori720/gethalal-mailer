...
class GM_CPL_List_Table extends WP_List_Table
{
    ...
    public function first_column($item, $field)
    {
        ...
        $config_id = $item['id'];
        $action_url = (empty($_SERVER['HTTPS']) ? "http://" : "https://") . $_SERVER['HTTP_HOST'] . $uri_parts[0] . "?page=gm_profit_config&id=$config_id";
    ...
    private function table_data()
    {
        ...
        $config_table = $wpdb->prefix . 'gethprofit_configs';
